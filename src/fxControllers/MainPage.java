...
public class MainPage implements Initializable {
    ...
    private void disableData() { //try to add variables to this instead
    ...
    public void createReply() throws IOException {
        ...
        createReply.setData(entityManagerFactory, (commentTree.getSelectionModel().getSelectedItem()).getValue());
    }
    ...
    private void addTreeItem(Comment comment, TreeItem<Comment> parent) {
    ...
    public void createDestination() throws IOException {
        ...
        createDestination.setData(entityManagerFactory, user);
        destinationList.getItems().clear();
        fillList();
    }
